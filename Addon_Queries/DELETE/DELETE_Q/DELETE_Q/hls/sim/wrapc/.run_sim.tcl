...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /work/Xilinx/Vitis/2024.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "delete_top.autotvin.dat"
	set constFileTvOut       "delete_top.autotvout.dat"
	set constFileHdlTvIn     "delete_top.autohdltvin.dat"
	set constFileHdlTvOut    "delete_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
