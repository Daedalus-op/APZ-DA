...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.delete_top.autotvin_i_hash_strm.dat"
         "c.delete_top.autotvin_i_col1_strm.dat"
         "c.delete_top.autotvin_i_col2_strm.dat"
         "c.delete_top.autotvin_i_col3_strm.dat"
         "c.delete_top.autotvin_i_payload_strm.dat"
         "c.delete_top.autotvin_i_e_strm.dat"
         "c.delete_top.autotvin_i_d_key1_strm.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.delete_top.autotvout_o_hash_strm.dat"
         "rtl.delete_top.autotvout_o_col1_strm.dat"
         "rtl.delete_top.autotvout_o_col2_strm.dat"
         "rtl.delete_top.autotvout_o_col3_strm.dat"
         "rtl.delete_top.autotvout_o_payload_strm.dat"
         "rtl.delete_top.autotvout_o_e_strm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
