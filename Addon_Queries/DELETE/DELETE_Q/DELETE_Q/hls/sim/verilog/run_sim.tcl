...
if {[file isfile delete_top.autotvin.dat]} {
	file delete -force delete_top.autotvin.dat
}

if {[file isfile delete_top.autotvout.dat]} {
	file delete -force delete_top.autotvout.dat
}
