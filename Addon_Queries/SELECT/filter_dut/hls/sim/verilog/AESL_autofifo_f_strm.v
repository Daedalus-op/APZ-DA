...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.filter_dut.autotvin_f_strm.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.filter_dut.autotvout_f_strm.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 7;
parameter DEPTH = 32'd 47;
