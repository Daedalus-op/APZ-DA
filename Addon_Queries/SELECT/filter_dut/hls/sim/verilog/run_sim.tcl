...
if {[file isfile filter_dut.autotvin.dat]} {
	file delete -force filter_dut.autotvin.dat
}

if {[file isfile filter_dut.autotvout.dat]} {
	file delete -force filter_dut.autotvout.dat
}
