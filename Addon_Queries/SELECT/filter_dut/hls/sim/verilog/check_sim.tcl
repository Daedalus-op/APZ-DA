...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.filter_dut.autotvin_filter_cfg_strm.dat"
         "c.filter_dut.autotvin_k_strms_0.dat"
         "c.filter_dut.autotvin_k_strms_1.dat"
         "c.filter_dut.autotvin_k_strms_2.dat"
         "c.filter_dut.autotvin_k_strms_3.dat"
         "c.filter_dut.autotvin_p_strm.dat"
         "c.filter_dut.autotvin_e_strm.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.filter_dut.autotvout_f_strm.dat"
         "rtl.filter_dut.autotvout_e_f_strm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
