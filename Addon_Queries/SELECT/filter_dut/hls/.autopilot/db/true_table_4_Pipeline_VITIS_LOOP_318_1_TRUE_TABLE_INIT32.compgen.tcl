...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename truetable \
    op interface \
    ports { truetable_address0 { O 10 vector } truetable_ce0 { O 1 bit } truetable_we0 { O 1 bit } truetable_d0 { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'truetable'"
}
}
