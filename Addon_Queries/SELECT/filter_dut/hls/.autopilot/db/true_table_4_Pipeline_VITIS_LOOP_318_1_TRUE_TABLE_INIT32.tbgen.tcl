set moduleName true_table_4_Pipeline_VITIS_LOOP_318_1_TRUE_TABLE_INIT32
set isTopModule 0
...
set C_modelName {true_table<4>_Pipeline_VITIS_LOOP_318_1_TRUE_TABLE_INIT32}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict truetable { MEM_WIDTH 1 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ truetable int 1 regular {array 1024 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "truetable", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ tt_cfg_strm_dout sc_in sc_lv 32 signal 1 } 
	{ tt_cfg_strm_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ tt_cfg_strm_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ tt_cfg_strm_empty_n sc_in sc_logic 1 signal 1 } 
	{ tt_cfg_strm_read sc_out sc_logic 1 signal 1 } 
	{ truetable_address0 sc_out sc_lv 10 signal 0 } 
	{ truetable_ce0 sc_out sc_logic 1 signal 0 } 
	{ truetable_we0 sc_out sc_logic 1 signal 0 } 
	{ truetable_d0 sc_out sc_lv 1 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "truetable_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "truetable", "role": "we0" }} , 
 	{ "name": "truetable_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "truetable", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	truetable { ap_memory {  { truetable_address0 mem_address 1 10 }  { truetable_ce0 mem_ce 1 1 }  { truetable_we0 mem_we 1 1 }  { truetable_d0 mem_din 1 1 } } }
