set moduleName parse_filter_config_4_32_Pipeline_VITIS_LOOP_467_5
set isTopModule 0
...
set C_modelName {parse_filter_config<4, 32>_Pipeline_VITIS_LOOP_467_5}
...
set portList { 
	...
	{ tt_cfg_strm_din sc_out sc_lv 32 signal 1 } 
	{ tt_cfg_strm_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ tt_cfg_strm_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ tt_cfg_strm_full_n sc_in sc_logic 1 signal 1 } 
	{ tt_cfg_strm_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
