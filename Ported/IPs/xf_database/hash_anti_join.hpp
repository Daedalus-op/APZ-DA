...
#pragma HLS bind_storage variable = i2_t_key_strm type = fifo impl = bram
    hls::stream<ap_uint<T_PW> > i2_t_pld_strm;
#pragma HLS STREAM variable = i2_t_pld_strm depth = 512
#pragma HLS bind_storage variable = i2_t_pld_strm type = fifo impl = bram
    hls::stream<ap_uint<ARW> > i2_nm_strm;
#pragma HLS STREAM variable = i2_nm_strm depth = 512
#pragma HLS bind_storage variable = i2_nm_strm type = fifo impl = bram
    hls::stream<bool> i2_e0_strm;
...
#pragma HLS bind_storage variable = o1_j_strm type = fifo impl = bram
    hls::stream<bool> o1_e_strm("b1");
#pragma HLS STREAM variable = o1_e_strm depth = 512
#pragma HLS bind_storage variable = o1_e_strm type = fifo impl = srl
    hls::stream<ap_uint<KEYW + S_PW + T_PW> > o2_j_strm("j2");
#pragma HLS STREAM variable = o2_j_strm depth = 512
#pragma HLS bind_storage variable = o2_j_strm type = fifo impl = bram
    hls::stream<bool> o2_e_strm("b2");
#pragma HLS STREAM variable = o2_e_strm depth = 512
#pragma HLS bind_storage variable = o2_e_strm type = fifo impl = srl
