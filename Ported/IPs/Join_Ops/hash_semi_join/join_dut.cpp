...
void join_dut(hls::stream<ap_uint<WKEY> > k_strms[HJ_CH_NM],
              ...
              // temp PU = 8
              ap_uint<WKEY> buf0[BUFF_DEPTH],
              ap_uint<WKEY> buf1[BUFF_DEPTH],
              ap_uint<WKEY> buf2[BUFF_DEPTH],
              ap_uint<WKEY> buf3[BUFF_DEPTH],
              ap_uint<WKEY> buf4[BUFF_DEPTH],
              ap_uint<WKEY> buf5[BUFF_DEPTH],
              ap_uint<WKEY> buf6[BUFF_DEPTH],
              ap_uint<WKEY> buf7[BUFF_DEPTH]) {
    // clang-format off
    ;
