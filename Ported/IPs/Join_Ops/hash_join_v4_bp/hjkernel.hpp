...
#define BLOOM_FILTER_W 14 // 24 is suggested in hardware, 16M bloom filter hash width
#define EN_BLOOM_FILTER 1 // bloom filter switch on-off
...
#define BUILD_CFG_DEPTH (12)   // number of s_unit, pu s base ptr * 8
