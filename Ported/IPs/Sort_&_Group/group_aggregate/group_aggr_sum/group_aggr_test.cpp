...
#define KEY_TYPE int
#define GAOP xf::database::AOP_SUM
#define FUN sum
...
void hls_db_group_aggr_sum(hls::stream<DATA_TYPE>& in_strm,
    ...
    xf::database::groupAggregate<GAOP, DATA_TYPE, DATA_TYPE, KEY_TYPE>(in_strm, e_in_strm, out_strm, e_out_strm,
                                                                       kin_strm, kout_strm);
}
...
int main() {
    ...
    hls_db_group_aggr_sum(din_strm, e_in_strm, dout_strm, e_out_strm, kin_strm, kout_strm);
