...
#define KEY_TYPE int
#define GAOP xf::database::AOP_COUNTNONZEROS
#define FUN numNonZeros
...
int main() {
    ...
    hls_db_group_aggr_cnt(din_strm, e_in_strm, dout_cnt_strm, e_out_strm, kin_strm, kout_strm);
    ...
    ref_group_aggr::FUN<DATA_TYPE, KEY_TYPE>(ref_din_strm, ref_dout_cnt_strm, ref_kin_strm, ref_kout_strm);
